...
const translations = {
  EN: {
    ...
    welcomeText2:
      " Whether you're looking for exciting activities or want to gather a group together, we offer an easy way to sign up for events and organize your own.\nTurn everyday moments into experiences and connect people in the right place at the right time.",
    weStoreYourDataText:
    ...
    biljardi: "Billiards",
    frisbeegolf: "Frisbee Golf",
    golf: "Golf",
    jaakiekko: "Ice Hockey",
    jalkapallo: "Football",
    juoksu: "Running",
    keilaus: "Bowling",
    koiralenkki: "Dog Walking",
    kiipeily: "Climbing",
  ...
  FI: {
    ...
    dateAndTime: "Aika",
    dataProtectionOfficer: "Tietosuojavastaava",
    ...
    welcomeText2:
      "Etsitpä sitten kiinnostavaa tekemistä tai haluat koota porukan kasaan, meiltä löydät helpon tavan ilmoittautua tapahtumiin ja järjestää omia.\nTee arjesta elämyksiä ja yhdistä ihmiset oikeassa paikassa, oikeaan aikaan.",
    weStoreYourDataText:
    ...
    // Lajit / Categoriat, avain nimetään kuten muuallakin koodissa eli pienillä kirjaimilla ja _ merkeillä välit ja ääkköset korvataan aakkosilla
